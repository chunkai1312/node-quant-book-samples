...
import { getMarketName } from '../ticker/utils/get-market-name.util';
...
export class ReportService {
  ...
  async export(options: { date: string }): Promise<ExcelJS.Buffer> {
    ...
    await this.addInstInvestorsTradesSheet(workbook, { ...options, market: Market.TSE });
    await this.addInstInvestorsTradesSheet(workbook, { ...options, market: Market.OTC });
